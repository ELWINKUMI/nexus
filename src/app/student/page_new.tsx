...
export default function StudentDashboard() {
  ...
  const mockSubjects = [
    { id: '1', name: 'Mathematics', teacher: 'Mr. Johnson', color: '#3b82f6', progress: 75 },
    { id: '2', name: 'English Language', teacher: 'Ms. Smith', color: '#8b5cf6', progress: 60 },
    { id: '3', name: 'Science', teacher: 'Dr. Williams', color: '#10b981', progress: 85 },
    { id: '4', name: 'History', teacher: 'Mrs. Brown', color: '#f59e0b', progress: 45 },
  ];

  const mockAssignments = [
    { id: '1', title: 'Math Homework Chapter 5', subject: 'Mathematics', dueDate: '2025-08-05', status: 'pending' },
    { id: '2', title: 'Science Lab Report', subject: 'Science', dueDate: '2025-08-06', status: 'submitted' },
    { id: '3', title: 'History Essay', subject: 'History', dueDate: '2025-08-08', status: 'pending' },
  ];

  const mockQuizzes = [
    { id: '1', title: 'Algebra Quiz', subject: 'Mathematics', timeLimit: 30, questions: 15 },
    { id: '2', title: 'Grammar Test', subject: 'English', timeLimit: 25, questions: 20 },
  ];
    ...
    <Box sx={{ 
      ...
      <Box sx={{
        ...
        <Box sx={{ p: 2 }}>
          ...
          <List sx={{ p: 0 }}>
            {[
              { label: 'Dashboard', icon: <SchoolIcon />, active: true },
              { label: 'My Subjects', icon: <SubjectIcon /> },
