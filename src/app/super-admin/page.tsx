...
// Renders date only on client to avoid hydration mismatch
                        ...
                        <TableRow key={school.id} sx={{ '&:hover': { bgcolor: '#f8fafc' } }}>
                          ...
                          <TableCell>
                            <Typography variant="body2" color="text.secondary">
                              ...
                              <ClientOnlyDate dateString={school.createdAt} />
                            </Typography>
                          </TableCell>
          ...
          <DialogContent sx={{ pt: 3 }}>
            ...
            {createdSchool && (
              <Alert severity="info" sx={{ mb: 2 }}>
                ...
                <Typography variant="body2">
                  <strong>ID:</strong> {createdSchool?.school?.admin?.id || 'N/A'}
                </Typography>
                <Typography variant="body2">
                  <strong>PIN:</strong> {createdSchool?.school?.admin?.pin || 'N/A'}
                </Typography>
